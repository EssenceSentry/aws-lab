...
QUESTIONS: tuple[PracticeQuestion, ...] = (
    PracticeQuestion(
        ...
        options=(
            ...
            (
                "The action is denied because the SCP path is a permission "
                "ceiling."
            ),
        ...
        correct_index=1,
        explanation=(
            "An SCP determines which actions are available to principals "
            "in the member account, but does not itself grant permission. "
            "Both the SCP "
    ...
    PracticeQuestion(
        ...
        correct_index=1,
        explanation=(
            "A cross-account role lets a trusted principal in another "
            "account assume permissions in the target account without a "
            "duplicated user."
        ),
    ...
    PracticeQuestion(
        ...
        prompt=(
            "AWS Managed Microsoft AD is to be shared through AWS "
            "Organizations. "
        ...
        explanation=(
            ...
            "features, same-Region sharing, and the directory in the "
            "organization's "
            "management/master account."
        ),
    ...
    PracticeQuestion(
        ...
        prompt=(
            "A partner account reads objects from your bucket and should "
            "bear the "
        ...
        correct_index=0,
        explanation=(
            "Requester Pays moves the modeled request-cost responsibility "
            "to the authenticated requester. Cross-account object access "
            "still needs an "
    ...
    PracticeQuestion(
        ...
        prompt=(
            "A platform team already has one CloudFormation template and "
            "wants to push the same baseline into many accounts and Regions. "
            "Which mechanism "
            "is the direct fit?"
        ),
        options=(
        ...
        correct_index=0,
        explanation=(
            "StackSets extend a CloudFormation template across selected "
            "accounts "
    ...
    PracticeQuestion(
        ...
        prompt=(
            "Teams need a controlled menu of approved infrastructure "
            "products and should be able to choose permitted parameters "
            "without editing IaC. "
    ...
    PracticeQuestion(
        ...
        prompt=(
            "An enterprise needs approved self-service products and also "
            "needs to distribute them consistently across accounts and "
            "Regions. Which design "
        ...
        correct_index=2,
        explanation=(
            "The combined pattern uses StackSets for multi-account/"
            "multi-Region "
    ...
    PracticeQuestion(
        ...
        prompt=(
            "VPC A peers with B, and B peers with C. No direct A-C peering "
            "exists. "
        ...
        correct_index=2,
        explanation=(
            "VPC peering does not provide transitive routing. A direct "
            "peering or a "
    ...
    PracticeQuestion(
        id="tgw-hub-spoke",
        prompt=(
            "Many VPCs need centralized hub-and-spoke and transitive "
            "routing, plus the hub may later attach VPN or Direct Connect. "
            "Which service matches "
        ...
        correct_index=0,
        explanation=(
            "Transit Gateway is the managed regional transit hub described "
            "for VPC, "
    ...
    PracticeQuestion(
        id="dxgw-vpc-transit",
        prompt=(
            "A private VIF connects to a Direct Connect gateway associated "
            "with VGWs in several Regions. The company also needs those VPCs "
            "to route to "
            "one another through this design. What is the issue?"
        ),
        options=(
            (
                "Direct Connect gateway does not provide the required "
                "VPC-to-VPC transit."
            ),
    ...
    PracticeQuestion(
        id="dx-transit-vif",
        prompt=(
            "A large hybrid estate has many VPCs in multiple locations and "
            "needs a scalable Direct Connect attachment. Which pattern does "
            "the chapter call "
        ...
        options=(
            ...
            (
                "A transit VIF to a Direct Connect gateway associated with "
                "Transit Gateway"
            ),
        ...
        correct_index=1,
        explanation=(
            "The supplied section favors the transit VIF + Direct Connect "
            "gateway + "
    ...
    PracticeQuestion(
        ...
        prompt=(
            "A VPC needs different custom DNS servers than those in its "
            "current DHCP "
        ...
        correct_index=1,
        explanation=(
            "DHCP options sets are treated as immutable: create a "
            "replacement and "
    ...
    PracticeQuestion(
        ...
        prompt=(
            "A VPC will use Route 53 private hosted-zone names and interface "
            "endpoint "
        ...
        correct_index=2,
        explanation=(
            "The supplied guide requires both attributes for the modeled "
            "private "
